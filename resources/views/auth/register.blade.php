                ...
                <form action="/register" method="POST" role="form" class="form-control">
                    ...
                    <div class="space-around my-2">
                        <input type="text" name="name" id="name" class="form-control forms_field-input"
                            placeholder="Tu nombre" data-rule="minlen:4" data-msg="Please enter at least 4 characters">
                    ...
                    <button type="submit" class="form-button-edit text-center space-around my-2 btn btn-info">Crear
                        cuenta</button>
                </form>

                <div class="form-link d-flex">
                        <p class="my-3">¿Eres ya de los nuestros?<a class="btn btn-info btn-sm ms-2"
