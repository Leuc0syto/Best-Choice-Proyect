        ...
        {{-- <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            ...
            <div class="mx-auto">
                <ul class="pagination">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
                        <li class="page-item text-dark disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
                    ...
                    @else
                        <li class="page-item text-dark disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
