        ...
        <div class="modal-content form-login">
            ...
            <div class="modal-body">
                ...
                <div class="form-container">
                    <form action="/login" method="POST" role="form">
                        ...
                        <input class="input-login form-control forms_field-input border-0 " type="email"
                            name="email" id="email" placeholder="{{ __('Tu correo') }}" data-rule="minlen:4"
                        ...
                        <button type="submit"
                            class="btn btn-login my-btn-call col-12 py-3 mt-5 text-dark justify-content-center"
                            style="background-color:#d3a1a0;">{{ __('Entrar') }}
                        </button>
                        <hr>
            ...
            <div class="modal-footer" style="background-color:#d3a1a0;">
                <p class="my-3 p-2 p-login">{{ __('¿Aún no eres de los nuestros?') }} <a
                        ...
                        href="{{ route('register') }}"data-bs-target="#exampleModalToggle2" data-bs-toggle="modal"
