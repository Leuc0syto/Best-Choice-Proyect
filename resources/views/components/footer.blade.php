    ...
    <footer class="py-5">
        <div class="row">
            ...
            <div class="col-6 col-md-3 px-5 mb-3">
                <h5>{{__('Categorías')}}</h5>
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">{{__('Ropa hombre')}}</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">{{__('Ropa mujer')}}</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">{{__('Ropa niño')}}</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">{{__('Unisex')}}</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">{{__('Complementos')}}</a></li>
                </ul>
            </div>
