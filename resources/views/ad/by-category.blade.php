    ...
    <div class="container mt-3">
        ...
        <div class="row">
            ...
            <div class="col-12 my-5 text-center">
                <h2 class="mb-5">{{__('Uy...parece que no hay nada de esta categoría')}}</h2>
                <a href="{{ route('ads.create') }}"
                    class="btn btn-warning btn-block my-btn-call p-2 ml-2 mx-3">{{__('Crear anuncio')}}</a>
                {{__('o')}}
                <a href="{{route('home')}}" class="btn btn-outline-warning my-btn mx-3">{{__('Vuelve a la home')}}</a>
            </div>
            @endforelse
            {{ $ads->links() }}
        </div>
