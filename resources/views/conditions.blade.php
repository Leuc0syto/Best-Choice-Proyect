    ...
    <div class="container text-center">
        <div class="col-12 mt-5">
            ...
            <p>{{__('Los presentes Términos y Condiciones de uso (en adelante, “Términos y Condiciones”) establecen las
                ...
                comunicación entre los usuarios ofertantes y los usuarios interesados en adquirir los artículos
                ofrecidos y la localización geográfica de los mismos, para completar la transacción.
                ...
                indispensable a la utilización del Servicio. Best Choice se reserva el derecho a actualizar y/o modificar
                los Términos y Condiciones en cualquier momento y por cualquier motivo a su exclusiva discreción.
                Best Choice notificará acerca de cualquier cambio material en los Términos y Condiciones o en cualquier
            ...
            <p> El titular y propietario del Servicio es Best Choice S.L. (en adelante, “Best Choice”), con domicilio en
                Avenida Meridiana 89, 6ª planta, C.P. 08026, Barcelona (España), provista de N.I.F. B-66049057,
            ...
            <h4>2. Necesidad de registro</h4>
            <p>Para poder utilizar el Servicio es necesario el previo registro del Usuario, la aceptación de los
                ...
                será responsable en todo momento de la custodia de su contraseña, asumiendo en consecuencia cualesquiera
                daños y perjuicios que pudieran derivarse de su uso indebido, así como de la cesión, revelación o
                extravío de la misma, debiendo informar inmediatamente a Best Choice en caso de que tenga motivos para
                creer que su contraseña ha sido utilizada de manera no autorizada o es susceptible de serlo. En
                cualquier caso, se considera que el Usuario es responsable por el acceso y/o uso del Servicio en
                relación con su cuenta, quien responderá en todo caso de dicho acceso y/o uso.

                Mediante la aceptación de los Términos y Condiciones, el Usuario consiente que sus datos pasen a formar
                parte del fichero de Best Choice y el tratamiento de esos datos será conforme a lo previsto en la <a href="{{route('privacy')}}">Política
                de Privacidad.</a>

                <h4>3. Normas de utilización del servicio</h4>
            <p> El Usuario se obliga a utilizar el Servicio conforme a lo establecido en la ley, la moral, el orden público y los presentes Términos y Condiciones. Asimismo, se obliga a hacer un uso adecuado del Servicio y a no emplearlo para realizar actividades ilícitas o constitutivas de delito, que atenten contra los derechos de terceros o que infrinjan cualquier norma del ordenamiento jurídico.
                ...
                No suplantar a otros Usuarios del Servicio ni transmitir los datos de acceso a la cuenta ni la contraseña a un tercero sin el consentimiento de Best Choice.
                ...
                Usar los servicios de Best Choice correctamente. Por ejemplo, no crear cuentas de usuario para beneficiarse de promociones del servicio de envíos o para evitar el pago de suscripciones de profesionales.
                No extraer de forma sistemática ni reutilizar parte o todo el contenido de los Servicios de Best Choice sin nuestro expreso consentimiento por escrito. En particular, no se permite el uso de herramientas o robots de búsqueda y extracción de datos para la extracción (ya sea en una o varias ocasiones) de partes sustanciales de los Servicios de Best Choice para su reutilización sin nuestro expreso consentimiento por escrito.
                El Usuario se obliga a mantener indemne a Best Choice ante cualquier posible reclamación, multa, pena o sanción que pueda venir obligada a soportar como consecuencia del incumplimiento por parte del Usuario de cualquiera de las normas de utilización antes indicadas, reservándose además Best Choice el derecho a solicitar la indemnización por daños y perjuicios que corresponda.
            </p>

            <h4>4. Infracción por parte de los de Usuarios</h4>
            <p>Best Choice se reserva el derecho a impedir el uso del Servicio, ya sea de forma temporal o definitiva, a cualquier Usuario que infrinja cualquiera de las normas establecidas en estos Términos y Condiciones, la ley o la moral.
            </p>

            <h4>5. Exclusión de responsabilidad</h4>
            <p>Best Choice no es propietaria de ninguno de los artículos en venta o vendidos a través de su plataforma y no es parte en la transacción de compraventa llevada a cabo exclusivamente entre compradores y vendedores ni revisa o valida los productos que los Usuarios ofrecen a través del Servicio, por lo que Best Choice no será responsable, ni directa ni indirectamente, ni subsidiariamente, de los daños y perjuicios de cualquier naturaleza derivados de la utilización y contratación de los contenidos y de las actividades de los Usuarios y/o de terceros a través del Servicio así como de la falta de licitud, fiabilidad, utilidad, veracidad, exactitud, exhaustividad y actualidad de los mismos.

                Con carácter enunciativo, y en ningún caso limitativo, Best Choice no será responsable por los daños y perjuicios de cualquier naturaleza derivados de:
                ...
                Best Choice responderá única y exclusivamente frente al Usuario de los Servicios que preste.
            </p>
        </div>
    </div>
</x-layout>
